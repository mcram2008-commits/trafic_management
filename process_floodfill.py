...
for name, filename in files.items():
    ...
    # The backgrounds are typically white or very close to white
    ImageDraw.floodfill(img, xy=(0, 0), value=(255, 255, 255, 0), thresh=40)
    ImageDraw.floodfill(img, xy=(img.width-1, 0), value=(255, 255, 255, 0), thresh=40)
    ImageDraw.floodfill(img, xy=(0, img.height-1), value=(255, 255, 255, 0), thresh=40)
    ImageDraw.floodfill(img, xy=(img.width-1, img.height-1), value=(255, 255, 255, 0), thresh=40)
...
print("Done updating images.js using floodfill!")
